...
export const renderBtn = (h, data, { props, listeners }) => {
  const expandHandler = listeners['expand-change'];

  let cls = ['operate-button'];
...
export const renderLabel = (h, data, context) => {
  ...
  const clickHandler = listeners['node-click'];
  const contextmenuHandler = listeners['contextmenu-click'];
  ...
  selectedClassName &&
    data[props.unique] == props.selectedId &&
      ...
      h(
        'div',
        {
          ...
          on: {
            ...
            contextmenu: e => contextmenuHandler && contextmenuHandler(e, data)
          }
        },
        childNodes
      )
